...
interface BunnyProxyInterface extends ethers.utils.Interface {
  functions: {
...
export type ProxyCreatedEvent = TypedEvent<
  [string, string] & { creator: string; proxy: string }
>;

export type UpgradedEvent = TypedEvent<[string] & { implementation: string }>;

export class BunnyProxy extends BaseContract {
  ...
  filters: {
    ...
    "ProxyCreated(address,address)"(
      creator?: null,
      proxy?: null
    ): TypedEventFilter<[string, string], { creator: string; proxy: string }>;
