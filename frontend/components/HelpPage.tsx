...
export default function HelpPage() {
    ...
    return <Box sx={{ flex: 1, display: "flex", flexDirection: "column" }}>
        ...
        <Box component="main" sx={{ flex: 1, bgcolor: '#eaeff1', display: "flex", flexDirection: "column" }}>
            ...
            {Img("/imgs/testnet-banner.png", "600px")}
            <hr />
            ...
            {Img("/imgs/depositPage.png", "600px")}
            ...
            <hr />
            <iframe style={{ margin: "0 auto" }} width="500" height={'200'} src="/imgs/testNote.pdf"></iframe>
            <hr />
            ...
            {Img("/imgs/paymentRequestPage.png", "600px")}
            <hr />
            ...
            {Img("/imgs/payWithCashNote.png", "600px")}
        </Box>
    </Box>
}